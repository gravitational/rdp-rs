...
pub enum LicenseMessage {
    ...
    ServerPlatformChallenge(PlatformChallenge),
...
impl LicenseMessage {
    fn new(payload: tpkt::Payload) -> RdpResult<Self> {
        ...
        match MessageType::try_from(message_type)? {
            ...
            MessageType::PlatformChallenge => Ok(Self::ServerPlatformChallenge(
...
pub fn client_connect<T: Read + Write>(
    ...
    match LicenseMessage::new(payload)? {
        LicenseMessage::ServerPlatformChallenge(platform_challenge) => {
